<template>
    <form @submit.prevent="onSave">
        ...
        <div class="form-row">
            <div class="form-group">
                <label>{{ $t("typeOfPowerline") }}</label>
                <select v-model="form.typeOfPowerline" :disabled="!isEdit" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input v-model="form.voltage" :disabled="!isEdit" class="form-control" />
                    <span class="input-group-text">{{ $t("KV") }}</span>
                </div>
            </div>

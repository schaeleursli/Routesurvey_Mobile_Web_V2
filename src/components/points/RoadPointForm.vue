<template>
    <form @submit.prevent="onSave">
        ...
        <!-- Section: Road Details -->
        <h5 class="section-title">{{ $t("roadDetails") || 'Road Details' }}</h5>
        <div class="form-row">
            <div class="form-group">
                <label>{{ $t("typeOfSurface") }}</label>
                <select v-model="form.typeOfSurface" :disabled="!isEdit" class="form-control">
            ...
            <div class="form-group">
                <label>{{ $t("numberOfLanes") }}</label>
                <input v-model="form.numberOfLines" :disabled="!isEdit" class="form-control" />
            </div>
